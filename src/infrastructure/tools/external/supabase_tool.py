...
class SupabaseTool(ArtesanatoBaseTool):
    ...
    description: str = (
        "Tool for querying Supabase database and retrieving schema information"
    )
        ...
        try:
            ...
            if hasattr(response, "data") and response.data:
                ...
                for column in response.data:
                    ...
                    elif column.get("numeric_precision") and column.get(
                        "numeric_scale"
                    ):
                    ...
                    # Add nullability
                    nullable = (
                        "NULL" if column.get("is_nullable") == "YES" else "NOT NULL"
                    )
