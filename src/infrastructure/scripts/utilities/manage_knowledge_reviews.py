        ...
        for file in files:
            if file.endswith(".md") or file.endswith("-summary.md"):
                ...
                try:
                    ...
                    if (
                        "**Reviewed: Not yet reviewed**" in content
                        or "Reviewed: Not yet reviewed" in content
                    ):
                        domain = os.path.relpath(root, CONTEXT_STORE_DIR).split(os.sep)[
                            0
                        ]
...
def mark_as_reviewed(
    filepath: str, reviewer_name: str, role: Optional[str] = None
) -> bool:
...
def log_review(
    filepath: str, reviewer_name: str, role: Optional[str], date: str
) -> None:
