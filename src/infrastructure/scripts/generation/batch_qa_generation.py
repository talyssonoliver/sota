...
from src.core.workflows.qa_validation import QAValidationEngine  # noqa: E402
from src.infrastructure.utils.completion_metrics import (  # noqa: E402
...
def main():
    ...
    parser.add_argument(
        "--max-tasks", type=int, help="Maximum tasks to process (for testing)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
