...
try:
    from src.platform.utils.feedback_system import FeedbackSystem, FeedbackEntry, FeedbackCategory
...
class EscalationEngine:
    ...
    def capture_escalation_feedback(self, event: EscalationEvent):
        ...
        try:
            ...
            from src.platform.utils.feedback_system import FeedbackEntry
