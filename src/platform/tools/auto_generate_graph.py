...
from src.platform.tools.graph_builder import build_dynamic_workflow_graph
...
if __name__ == "__main__":
    ...
    print("from src.platform.tools.auto_generate_graph import build_auto_generated_workflow_graph")
