...
try:
    ...
    print(f"Warning: LangGraph imports failed in notifications: {e}")
...
class SlackNotifier:
    ...
    def should_notify(self, event_type: str, state: Dict[str, Any]) -> bool:
        ...
        if self.notification_level == NotificationLevel.COMPLETION:
            return event_type == "node_end" and state.get(
    ...
    def format_message(self, event_type: str, node_id: str,
        ...
        if event_type == "node_start":
            ...
            text = f"Error in agent *{node_id}* while processing task *{task_id}*: {
                state.get(
                    'error',
                    'Unknown error')}"
...
def attach_notifications_to_workflow(workflow: Union[Graph,
                                     ...
                                     notification_level: NotificationLevel = NotificationLevel.ALL) -> Union[Graph,
                                                                                                             StateGraph]:
    """
