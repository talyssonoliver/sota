...
from src.platform.utils.task_loader import (get_all_tasks, load_task_metadata,
                               save_task_metadata)
...
class TaskDeclarationManager:
    ...
    def _get_prompt_template(self, agent_role: str) -> str:
        ...
        # Basic prompt template - in practice, this would load from prompts/
        # directory
