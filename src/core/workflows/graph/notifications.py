...
try:
    ...
    Graph = DummyStateGraph  # type: ignore
try:
...
class SlackNotifier:
    ...
    def format_message(
        self, event_type: str, node_id: str, state: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        attachments = [
            {
                ...
                "fields": [
                    ...
                    {"title": "Agent", "value": node_id, "short": True},
...
def attach_notifications_to_workflow(
    workflow,
