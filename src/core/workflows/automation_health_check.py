...
class AutomationHealthChecker:
    ...
    async def run_comprehensive_health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(
                f"Health check completed - Status: {results['overall_status']}"
            )
    ...
    def _check_reporting_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": (
                    "healthy" if (reports_exist and briefings_exist) else "warning"
                ),
    ...
    def _check_file_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "issues": [
                    f"Missing: {p}" for p, s in path_status.items() if not s["exists"]
                ],
            }
...
async def main():
    ...
    if args.output == "json":
        ...
        output_file = (
            args.save or f"health_check_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
