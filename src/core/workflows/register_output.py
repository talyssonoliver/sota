...
class AgentOutputRegistry:
    ...
    def register_output(self, task_id, agent_id, source_path, output_type="json", metadata=None):
        ...
        for output in task_outputs:
            ...
            if agent_id:
                agent_outputs[agent_id] = {
                    ...
                    "completion_time": output.get("timestamp"),  # Same as timestamp for completion
