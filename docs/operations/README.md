...
- **enhanced_workflow.md** - Advanced workflow patterns and optimization
- **execute_graph.md** - Graph execution strategies and monitoring
- **execute_task.md** - Individual task execution procedures
- **execute_workflow.md** - Complete workflow execution pipelines  
- **resilient_workflow.md** - Error recovery and resilience patterns
- **run_workflow.md** - Workflow runtime management
- **knowledge_curation_workflow.md** - Knowledge management workflows
- **langgraph_workflow.md** - LangGraph-specific workflow implementations

### 🤖 [Automation](./automation/)
Automated system operations and health management
- **automation_health_check.md** - Automated health monitoring and alerts

### 📊 [Monitoring](./monitoring/)
System monitoring, observability, and performance tracking
- **monitor_workflow.md** - Workflow execution monitoring and metrics

## 🚀 Operational Procedures

### **System Deployment**
1. **Pre-deployment Checks**
   - Run health checks from [automation/automation_health_check.md](./automation/automation_health_check.md)
   - Verify workflow configurations in [workflows/](./workflows/)

2. **Workflow Deployment**
   - Follow [workflows/execute_workflow.md](./workflows/execute_workflow.md) for deployment procedures
   - Implement resilience patterns from [workflows/resilient_workflow.md](./workflows/resilient_workflow.md)

3. **Post-deployment Monitoring**
   - Set up monitoring using [monitoring/monitor_workflow.md](./monitoring/monitor_workflow.md)
   - Configure automated health checks

### **Production Operations**

#### **Workflow Management**
- **Execution**: Use [workflows/run_workflow.md](./workflows/run_workflow.md) for runtime management
- **Task Management**: Reference [workflows/execute_task.md](./workflows/execute_task.md) for individual tasks
- **Graph Operations**: Follow [workflows/execute_graph.md](./workflows/execute_graph.md) for graph-level operations

#### **Health & Monitoring**
- **Health Checks**: Automated via [automation/automation_health_check.md](./automation/automation_health_check.md)
- **Performance Monitoring**: Continuous monitoring through [monitoring/monitor_workflow.md](./monitoring/monitor_workflow.md)
- **Error Recovery**: Resilience patterns in [workflows/resilient_workflow.md](./workflows/resilient_workflow.md)

#### **Knowledge Management**
- **Curation Workflows**: Follow [workflows/knowledge_curation_workflow.md](./workflows/knowledge_curation_workflow.md)
...
*For operational status and reports, check [reports/](../reports/) and [sprint briefings](../sprint/briefings/).*