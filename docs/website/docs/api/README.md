...
CLAUDE_API_KEY=sk-ant-your-claude-key          # Primary AI provider
ANTHROPIC_API_KEY=sk-ant-your-anthropic-key    # Alternative format
OPENAI_API_KEY=sk-your-openai-key              # Legacy support
...
- `tasks/*.yaml` - Task specifications (95+ files)
