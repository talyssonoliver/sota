...
- **Total directories**: 364 (directories only - partial view)
...
- **1,948 files** across the entire project
- **364 directories** with full hierarchy
- **319,344 total lines** of code and documentation
