...
from src.infrastructure.utils.completion_metrics import CompletionMetricsCalculator  # noqa: E402
...
def tearDown(self):
    ...
    def test_dashboard_updater_initialization(self):
        ...
        self.assertIsInstance(
            self.updater.metrics_calculator, CompletionMetricsCalculator
        )
    ...
    def test_coverage_chart_data_generation(self):
        ...
        self.assertEqual(
            chart_data["data"]["labels"], ["2025-05-25", "2025-05-26", "2025-05-27"]
        )
    ...
    @patch(
        "src.infrastructure.scripts.monitoring.update_dashboard.CompletionMetricsCalculator"
    )
...
class TestProgressReportGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.generator = ProgressReportGenerator(
            str(self.outputs_dir), str(self.reports_dir)
        )
    ...
    @patch(
        "src.infrastructure.scripts.generation.generate_progress_report.CompletionMetricsCalculator"
    )
    def test_daily_report_generation(self, mock_calculator):
        ...
        report = generator.generate_simple_daily_report()
...
class TestIntegration(unittest.TestCase):
    ...
    @patch(
        "src.infrastructure.utils.completion_metrics.CompletionMetricsCalculator.calculate_all_metrics"
    )
