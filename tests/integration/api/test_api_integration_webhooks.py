...
class TestWebhookManager:
    ...
    def test_webhook_delivery_basic(self):
        ...
        assert event["data"]["task_id"] == "test_task"
...
class TestExternalAPIManager:
    ...
    def test_request_lifecycle_tracking(self):
        ...
        self.api_manager.update_request_status(
            request_id, "completed", {"result": "success"}
        )
        status = self.api_manager.get_request_status(request_id)
...
class TestJIRAIntegration:
    ...
    def test_basic_functionality(self):
        ...
        assert (
            self.jira_integration.config.auth_config["username"] == "test@example.com"
        )
