...
class TestFeedbackAnalyzer:
    ...
    def test_analyze_task_feedback_no_feedback(self):
        ...
        with patch.object(
            self.analyzer.feedback_system, "get_feedback_by_task", return_value=[]
        ):
    ...
    def test_analyze_task_feedback_with_data(self):
        ...
        mock_feedback = [
            Mock(
                ...
                task_id="BE-07",
                content="The code needs better error handling and documentation",
            ...
            Mock(
                ...
                task_id="BE-07",
                content="Performance is slow, needs optimization",
                timestamp=datetime.now().isoformat(),
                overall_score=5,
        ...
        with patch.object(
            self.analyzer.feedback_system,
            "get_feedback_by_task",
            return_value=mock_feedback,
        ), patch.object(self.analyzer, "_save_analysis_results"):
            result = self.analyzer.analyze_task_feedback("BE-07")
            assert result["task_id"] == "BE-07"
    ...
    def test_analyze_all_feedback_no_data(self):
        ...
        with patch.object(
            self.analyzer.feedback_system, "get_feedback_by_period", return_value=[]
        ):
    ...
    def test_analyze_all_feedback_with_data(self):
        ...
        mock_feedback = [
            Mock(
                spec=["task_id", "agent_name", "content", "timestamp", "overall_score"],
                task_id="BE-07",
                agent_name="backend_agent",
                content="Error handling needs improvement",
                timestamp=datetime.now().isoformat(),
                overall_score=6,
            ),
            Mock(
                ...
                content="Performance optimization required",
                timestamp=datetime.now().isoformat(),
                overall_score=7,
            ),
        ]
    ...
    def test_analyze_feedback_summary(self):
        ...
        mock_feedback = [
            Mock(
                spec=["category_scores", "overall_score"],
                category_scores={"code_quality": 8, "documentation": 6},
                overall_score=7,
            ),
            Mock(
                spec=["category_scores", "overall_score"],
                category_scores={"code_quality": 6, "performance": 5},
                overall_score=5,
            ),
        ]
    ...
    def test_identify_recurring_edits(self):
        ...
        mock_feedback = [
            Mock(
                spec=["task_id", "content", "timestamp"],
                task_id="BE-07",
                content="Need to rename this function for better naming conventions",
                timestamp=datetime.now().isoformat(),
            ),
            Mock(
                spec=["task_id", "content", "timestamp"],
                task_id="BE-08",
                content="Should refactor this code structure for better organization",
                timestamp=datetime.now().isoformat(),
            ),
            Mock(
                spec=["task_id", "content", "timestamp"],
                task_id="BE-09",
                content="Add error handling and exception management",
                timestamp=datetime.now().isoformat(),
            ),
        ]
    ...
    def test_suggest_prompt_modifications(self):
        ...
        mock_feedback = [
            Mock(
                spec=["content"], content="The instructions are unclear and confusing"
            ),
            Mock(
                spec=["content"],
                content="Missing important context about the requirements",
            ),
            Mock(
                spec=["content"],
                content="Need more specific details about the implementation",
            ),
            Mock(
                spec=["content"],
                content="The prompt is ambiguous and hard to understand",
            ),
        ]
    ...
    def test_suggest_tool_improvements(self):
        ...
        mock_feedback = [
            Mock(
                spec=["content"], content="The tool is slow and has performance issues"
            ),
    ...
    def test_suggest_context_adjustments(self):
        ...
        mock_feedback = [
            Mock(
                spec=["content"], content="Missing context and background information"
            ),
            Mock(
                spec=["content"],
                content="Irrelevant context provided, not related to task",
            ),
    ...
    def test_generate_fine_tuning_examples(self):
        ...
        mock_feedback = [
            Mock(
                spec=["task_id", "content", "agent_output", "overall_score"],
                task_id="BE-07",
                content="Excellent implementation with good error handling",
                agent_output="def process_data(): ...",
                overall_score=9,
            ),
            Mock(
                spec=["task_id", "content", "agent_output", "overall_score"],
                task_id="BE-08",
                content="Poor implementation needs major improvements",
                agent_output="def bad_function(): ...",
                overall_score=3,
            ),
        ]
        ...
        feedback_by_agent = {
            "backend_agent": [
                ...
                Mock(
                    spec=["overall_score", "content"],
                    overall_score=6,
                    content="Needs accuracy improvement",
                ),
            ],
            "frontend_agent": [
                Mock(
                    spec=["overall_score", "content"],
                    overall_score=7,
                    content="Fast but could be better quality",
                )
            ],
        }
    ...
    def test_analyze_task_patterns(self):
        ...
        feedback_by_task = {
            "BE-07": [Mock(overall_score=8), Mock(overall_score=6)],
            "BE-08": [Mock(overall_score=7)],
            "FE-01": [Mock(overall_score=9)],
        }
    ...
    def test_suggest_system_improvements(self):
        ...
        mock_feedback = [
            Mock(content="System is slow and has performance issues"),
            Mock(content="Error occurred and system crashed"),
            Mock(content="User interface needs improvement"),
        ]
    ...
    def test_generate_training_recommendations(self):
        ...
        mock_feedback = [
            Mock(content="Prompt engineering needs improvement"),
            Mock(content="Code quality is poor"),
            Mock(content="Documentation standards not followed"),
            Mock(content="Testing methodology is inadequate"),
        ]
    ...
    def test_calculate_average_score(self):
        ...
        mock_feedback = [
            Mock(overall_score=8),
            Mock(overall_score=6),
            Mock(overall_score=7),
        ]
    ...
    def test_identify_agent_improvement_areas(self):
        ...
        mock_feedback = [
            Mock(content="Accuracy is wrong and needs correction"),
            Mock(content="Speed is slow and needs to be faster"),
            Mock(content="Quality is better but still needs improvement"),
        ]
    ...
    def test_generate_report_markdown(self):
        ...
        analysis = {
            ...
            "feedback_count": 5,
            "summary": {"total_feedback": 5, "average_overall_score": 7.2},
            "recurring_edits": [{"pattern": "naming_conventions", "frequency": 3}],
            "overall_recommendations": ["Focus on addressing recurring edit patterns"],
        }
    ...
    def test_save_analysis_results(self):
        ...
        with patch("builtins.open", create=True) as mock_open, patch(
            ...
            mock_dump.assert_called_once_with(
                analysis, mock_open().__enter__(), indent=2, default=str
            )
    ...
    def test_helper_methods(self):
        ...
        assert "context window" in self.analyzer._get_context_suggestion(
            "insufficient_context"
        )
        assert "filtering" in self.analyzer._get_context_suggestion(
            "irrelevant_context"
        )
        assert (
            "performance monitoring"
            in self.analyzer._get_system_improvement_suggestion("performance")
        )
        assert "error handling" in self.analyzer._get_system_improvement_suggestion(
            "reliability"
        )
        assert "prompt design" in self.analyzer._get_training_recommendation(
            "prompt_engineering"
        )
        assert "code quality" in self.analyzer._get_training_recommendation(
            "code_quality"
        )
...
class TestFeedbackAnalyzerCLI:
    ...
    def test_main_with_task_argument(self):
        ...
        with patch("sys.argv", ["script", "--task", "BE-07"]), patch(
            "src.integrations.analytics.analyse_feedback.FeedbackAnalyzer"
        ) as mock_analyzer_class:
            mock_analyzer = Mock()
            mock_analyzer.analyze_task_feedback.return_value = {
                "task_id": "BE-07",
                "feedback_count": 3,
            }
    ...
    def test_main_comprehensive_analysis(self):
        ...
        with patch("sys.argv", ["script", "--period", "14"]), patch(
            "src.integrations.analytics.analyse_feedback.FeedbackAnalyzer"
        ) as mock_analyzer_class:
            mock_analyzer = Mock()
            mock_analyzer.analyze_all_feedback.return_value = {
                "total_feedback": 10,
                "period_days": 14,
            }
    ...
    def test_main_with_output_file(self):
        ...
        with patch(
            "sys.argv", ["script", "--task", "BE-07", "--output", "report.md"]
        ), patch(
            "src.integrations.analytics.analyse_feedback.FeedbackAnalyzer"
    ...
    def test_end_to_end_task_analysis(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_feedback = [
                Mock(
                    task_id="BE-07",
                    content="Code needs better error handling and documentation. Performance is slow.",
                    timestamp=datetime.now().isoformat(),
                    overall_score=6,
                    category_scores={
                        "code_quality": 7,
                    ...
                    agent_output="def process_data(): return data",
                )
            ]
            with patch.object(
                analyzer.feedback_system,
                "get_feedback_by_task",
                return_value=mock_feedback,
            ):
