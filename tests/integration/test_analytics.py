...
class TestFeedbackAnalyzer:
    ...
    def test_analyze_task_feedback_with_data(self):
        ...
        with patch.object(self.analyzer.feedback_system, 'get_feedback_by_task', return_value=mock_feedback), \
    ...
    def test_analyze_all_feedback_with_data(self):
        ...
        with patch.object(self.analyzer.feedback_system, 'get_feedback_by_period', return_value=mock_feedback), \
             patch.object(self.analyzer, '_save_analysis_results'):
    ...
    def test_suggest_prompt_modifications(self):
        ...
        mock_feedback = [
            Mock(content="The instructions are unclear and confusing"),
            Mock(content="Missing important context about the requirements"),
            Mock(content="Need more specific details about the implementation"),
            Mock(content="The prompt is ambiguous and hard to understand")
        ]
    ...
    def test_suggest_tool_improvements(self):
        ...
        mock_feedback = [
            Mock(content="The tool is slow and has performance issues"),
            Mock(content="Tool function failed with an error"),
            Mock(content="Missing functionality in the tool")
        ]
    ...
    def test_suggest_context_adjustments(self):
        ...
        mock_feedback = [
            Mock(content="Missing context and background information"),
            Mock(content="Irrelevant context provided, not related to task"),
            Mock(content="Context is outdated and needs updating")
        ]
    ...
    def test_analyze_global_patterns(self):
        ...
        mock_feedback = [
            Mock(content="Error occurred during processing"),
            Mock(content="Performance is very slow"),
            Mock(content="Documentation is missing"),
            Mock(content="Tests are failing")
        ]
    ...
    def test_analyze_agent_performance(self):
        ...
        feedback_by_agent = {
            "backend_agent": [
                Mock(overall_score=8, content="Good performance"),
                Mock(overall_score=6, content="Needs accuracy improvement")
            ],
            "frontend_agent": [
                Mock(overall_score=7, content="Fast but could be better quality")
            ]
        }
    ...
    def test_generate_report_markdown(self):
        ...
        analysis = {
            ...
            "recurring_edits": [
                {"pattern": "naming_conventions", "frequency": 3}
            ],
            "overall_recommendations": [
                "Focus on addressing recurring edit patterns"
            ]
        }
    ...
    def test_helper_methods(self):
        ...
        # Test system improvement suggestion
...
class TestFeedbackAnalyzerCLI:
    ...
    def test_main_with_task_argument(self):
        ...
        with patch('sys.argv', ['script', '--task', 'BE-07']), \
             patch('analytics.analyse_feedback.FeedbackAnalyzer') as mock_analyzer_class:
    ...
    def test_main_comprehensive_analysis(self):
        ...
        with patch('sys.argv', ['script', '--period', '14']), \
             patch('analytics.analyse_feedback.FeedbackAnalyzer') as mock_analyzer_class:
    ...
    def test_main_with_output_file(self):
        ...
        with patch('sys.argv', ['script', '--task', 'BE-07', '--output', 'report.md']), \
             patch('analytics.analyse_feedback.FeedbackAnalyzer') as mock_analyzer_class, \
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_feedback = [
                Mock(
                    ...
                    timestamp=datetime.now().isoformat(),
                    overall_score=6,
                    category_scores={"code_quality": 7, "documentation": 5, "performance": 4},
