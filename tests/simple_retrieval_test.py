...
class TestRetrievalQA(unittest.TestCase):
    ...
    def test_retrieval_qa_chain_integration(self, mock_chat_openai, mock_from_chain_type):
        ...
        # Access the method directly using a lambda because retrieval_qa is an instance method
        with patch('langchain.chains.retrieval_qa.base.RetrievalQA', MagicMock()):
            ...
            def mock_retrieval_qa(self, query, use_conversation=False, metadata_filter=None, temperature=0, user="system"):
            ...
            with patch.object(MemoryEngine, 'retrieval_qa', mock_retrieval_qa):
                ...
                # Verify that from_chain_type was called with the right arguments
