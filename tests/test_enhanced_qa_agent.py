...
from utils.test_generator import TestGenerator, TestFramework, TestCase, TestSuite
...
""")
    ...
    def test_qa_agent_initialization(self, temp_project):
        ...
        assert isinstance(agent.test_generator, TestGenerator)
    ...
    def test_get_test_file_path_pytest(self, qa_agent):
        ...
        test_path = qa_agent._get_test_file_path("src/sample.py", TestFramework.PYTEST)
    ...
    def test_get_test_file_path_jest(self, qa_agent):
        ...
        test_path = qa_agent._get_test_file_path("src/sample.js", TestFramework.JEST)
    ...
    def test_calculate_quality_metrics(self, qa_agent):
        ...
        assert abs(metrics["test_generation_success_rate"] - (200/3)) < 0.01  # 2 success out of 3
    ...
    def test_calculate_overall_quality_score(self, qa_agent):
        ...
        # Should be a weighted combination of test success, coverage, and integration
        assert 0 <= score <= 100
...
""")
    ...
    @patch('utils.test_generator.TestGenerator.generate_test_file')
