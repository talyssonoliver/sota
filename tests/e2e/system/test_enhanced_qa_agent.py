...
Migrated from: tests/agents\test_enhanced_qa_agent.py
New location: tests/e2e\system\test_enhanced_qa_agent.py
...
""")
    ...
    @patch('tests.components.test_generator.QATestGenerator.generate_test_file')
