...
from src.infrastructure.utils.test_generator import (QATestFramework, QATestGenerator)
...
""")
    ...
    @patch('src.infrastructure.utils.test_generator.QATestGenerator.generate_test_file')
