#!/usr/bin/env python3
"""
test_prompt_generation.py - Optimized Test Structure

Migrated from: tests/components/test_prompt_generation.py
New location: tests/e2e/system/test_prompt_generation.py
...
"""
    ...
    def test_get_task_context_with_valid_task(self, mock_task_metadata):
        ...
        with patch('src.core.workflows.generate_prompt.load_task_metadata') as mock_load_task, \
                patch('src.core.workflows.generate_prompt.get_memory_instance') as mock_get_memory:
            ...
            mock_get_memory.return_value = mock_engine_instance
    ...
    def test_get_task_context_file_not_found(self):
        """Test context retrieval when task file does not exist."""
        with patch('src.core.workflows.generate_prompt.load_task_metadata') as mock_load_task:
    ...
    def test_generate_prompt_template_not_found(self, mock_task_metadata):
        """Test prompt generation when template file does not exist."""
        with patch('src.core.workflows.generate_prompt.load_prompt_template') as mock_load_template, \
                patch('src.core.workflows.generate_prompt.load_task_metadata') as mock_load_task:
    ...
    def test_generate_prompt_task_metadata_not_found(self, mock_prompt_template):
        """Test prompt generation when task metadata does not exist."""
        with patch('src.core.workflows.generate_prompt.load_prompt_template') as mock_load_template, \
                patch('src.core.workflows.generate_prompt.load_task_metadata') as mock_load_task:
...
""")
        ...
        template_content = """# Test Agent Prompt
