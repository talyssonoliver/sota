...
def setup_test_environment(test_name: str = "test") -> Dict[str, Any]:
    ...
    return {
        'env': test_env,
        'dirs': test_dirs,
        'cleanup_func': lambda: cleanup_test_environment(temp_dir)
    }
...
class FeedbackCollector:
    ...
    def print_result(result_data=None, **kwargs):
        ...
        # Handle case where all data is in kwargs
        ...
        # Return the passed status if available
