...
from .test_utils import create_temporary_directory, create_temporary_file
...
class WorkflowTestHelper:
    ...
    def create_mock_agent(self, agent_type: str, **kwargs) -> Mock:
        ...
        mock_agent.execute_task = Mock(return_value={
            ...
            'metadata': {'agent': agent_type, 'timestamp': datetime.now().isoformat()}
        })
    ...
    def create_mock_task(self, task_id: str, **kwargs) -> Dict[str, Any]:
        ...
        task = {
            ...
            'description': kwargs.get('description', f'Mock task {task_id} for testing'),
            ...
            'estimated_duration': kwargs.get('estimated_duration', 300),  # 5 minutes
    ...
    def create_test_workflow_config(self, **kwargs) -> Dict[str, Any]:
        ...
        return {
            ...
            'tasks': kwargs.get('tasks', [
                ...
                {'id': 'task_2', 'agent_type': 'qa_agent', 'dependencies': ['task_1']}
            ]),
            'max_iterations': kwargs.get('max_iterations', 10),
            'timeout': kwargs.get('timeout', 3600),  # 1 hour
