...
from utils.test_generator import TestGenerator, TestFramework, CodeLanguage
...
""")
    ...
    def test_determine_test_framework_python(self, qa_agent):
        ...
        assert framework in [TestFramework.PYTEST, TestFramework.UNITTEST]
    ...
    def test_get_test_file_path(self, qa_agent):
        ...
        pytest_path = qa_agent._get_test_file_path("src/sample.py", TestFramework.PYTEST)
        assert "test_sample.py" in str(pytest_path)
        assert "tests" in str(pytest_path) and "generated" in str(pytest_path)
        
        jest_path = qa_agent._get_test_file_path("src/utils.js", TestFramework.JEST)
    ...
    def test_calculate_quality_metrics(self, qa_agent):
        ...
        assert metrics['test_generation_success_rate'] == (2/3) * 100  # 2 success out of 3
