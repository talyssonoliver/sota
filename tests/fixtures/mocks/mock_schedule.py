...
class MockSchedule:
    ...
    def run_pending(self):
        ...
        # In real implementation, this would run scheduled jobs
        pass
    
    def clear(self, tag: str = None):
        """Mock clear method."""
        if tag:
            # In real implementation, would clear jobs with specific tag
            pass
        else:
            self.jobs.clear()
    ...
    def get_jobs(self, tag: str = None):
        ...
        if tag:
            # In real implementation, would filter by tag
            return []
        return self.jobs


# Create global schedule instance
