...
from utils.test_generator import (
    TestGenerator, TestFramework, CodeLanguage, TestCase, TestSuite
)
...
""")
    ...
    def test_generator(self, temp_project):
        ...
        return TestGenerator(str(temp_project))
    
    def test_generate_edge_case_tests(self, test_generator):
        """Test edge case test generation."""
        analysis = {
            "functions": [
                {"name": "process_data", "args": ["data", "options"], "line": 10},
                {"name": "calculate", "args": ["x", "y"], "line": 20}
            ]
        }
        
        edge_tests = test_generator._generate_edge_case_tests(analysis, TestFramework.PYTEST)
        
        assert len(edge_tests) == 2
        assert all(isinstance(test, TestCase) for test in edge_tests)
    ...
    def test_generate_integration_tests(self, test_generator):
        ...
        analysis = {
            "classes": [
                {"name": "DatabaseManager", "methods": ["connect", "execute_query"]},
                {"name": "UserService", "methods": ["create_user", "get_user"]}
            ]
        }
        
        integration_tests = test_generator._generate_integration_tests(analysis, TestFramework.PYTEST)
    ...
    def test_generate_integration_tests_insufficient_classes(self, test_generator):
        ...
        assert len(integration_tests) == 0  # No integration tests for single class
    ...
    def test_generate_error_handling_tests(self, test_generator):
        ...
        error_tests = test_generator._generate_error_handling_tests(analysis, TestFramework.PYTEST)
    ...
    def test_generate_integration_test_code_jest(self, test_generator):
        ...
        code = test_generator._generate_integration_test_code(classes, TestFramework.JEST)
    ...
    def test_generate_integration_test_code_pytest(self, test_generator):
        ...
        code = test_generator._generate_integration_test_code(classes, TestFramework.PYTEST)
    ...
    def test_generate_error_test_code_jest(self, test_generator):
        ...
        code = test_generator._generate_error_test_code("validateInput", TestFramework.JEST)
    ...
    def test_generate_error_test_code_pytest(self, test_generator):
        ...
        code = test_generator._generate_error_test_code("validate_input", TestFramework.PYTEST)
    ...
    def test_generate_performance_tests(self, test_generator):
        ...
        perf_tests = test_generator.generate_performance_tests(analysis, TestFramework.PYTEST)
    ...
    def test_generate_performance_test_code_jest(self, test_generator):
        ...
        code = test_generator._generate_performance_test_code("heavyComputation", TestFramework.JEST)
    ...
    def test_generate_performance_test_code_pytest(self, test_generator):
        ...
        code = test_generator._generate_performance_test_code("heavy_computation", TestFramework.PYTEST)
    ...
    def test_generate_security_tests(self, test_generator):
        ...
        analysis = {
            "functions": [
                ...
                {"name": "calculate", "args": ["x", "y"], "line": 40}  # Should not generate security test
            ]
        }
        
        security_tests = test_generator.generate_security_tests(analysis, TestFramework.PYTEST)
        
        # Should generate tests for functions with security-relevant names
        assert len(security_tests) >= 2  # process_user_input, parse_xml, handle_upload
        
        security_test_names = [test.name for test in security_tests]
        assert any("process_user_input" in name for name in security_test_names)
    ...
    def test_generate_security_test_code_jest(self, test_generator):
        ...
        code = test_generator._generate_security_test_code("processInput", TestFramework.JEST)
    ...
    def test_generate_security_test_code_pytest(self, test_generator):
        ...
        code = test_generator._generate_security_test_code("process_input", TestFramework.PYTEST)
    ...
    def test_enhanced_test_suite_generation(self, test_generator):
        ...
        analysis = {
            ...
            "classes": [
                {"name": "DatabaseManager", "methods": ["connect", "execute_query"], "line": 1},
                {"name": "UserService", "methods": ["create_user", "get_user"], "line": 20}
            ],
            "functions": [
                {"name": "process_user_input", "args": ["input_data"], "line": 50, "is_async": False},
                {"name": "handle_file_upload", "args": ["file_path"], "line": 60, "is_async": False}
            ],
        ...
        test_suite = test_generator._generate_test_suite(
            analysis, TestFramework.PYTEST, CodeLanguage.PYTHON
        )
        ...
        assert "integration" in test_types  # Should have integration tests due to multiple classes
          # Should have tests for both classes
        test_names = [test.name for test in test_suite.test_cases]        # Check that we have tests for the classes (either by name or class reference)
        class_tests_found = any(any(cls_name.lower() in name.lower() for cls_name in ["database", "user", "service", "manager"]) 
                               for name in test_names)
        assert class_tests_found
          # Should have security tests for input/upload functions
        assert any("security" in test.test_type.lower() for test in test_suite.test_cases) or \
               any("security" in test.name.lower() for test in test_suite.test_cases)
        
        # Should have error handling tests
        assert any("error_handling" in name for name in test_names)
    
    def test_comprehensive_file_generation_with_real_analysis(self, test_generator, temp_project):
        ...
        # Should include security tests for input handling functions (might be in error handling)
        assert ("security" in test_content.lower() or "malicious" in test_content.lower() or 
                "error" in test_content.lower() or "exception" in test_content.lower())
        
        # Should include error handling
        assert "error" in test_content.lower() or "exception" in test_content.lower()


class TestTestGeneratorPatterns:
