"""
test_end_of_day_reporting.py - Optimized Test Structure

Migrated from: tests/workflows/test_end_of_day_reporting.py
New location: tests/unit/core/test_end_of_day_reporting.py
