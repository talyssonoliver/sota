...
class TestStep43WorkflowExecution:
    ...
    def test_build_task_state_success(self, mock_task_metadata):
        ...
        with patch('src.core.workflows.execute_graph.load_task_metadata') as mock_load_task, \
                patch('src.core.workflows.execute_graph.get_relevant_context') as mock_get_context:
