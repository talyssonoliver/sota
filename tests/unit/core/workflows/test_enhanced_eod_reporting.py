...
try:
    ...
    _analyze_tomorrow_preparation = None
    _assess_sprint_health = None
    _calculate_sprint_velocity = None
    _create_enhanced_eod_report = None
    _generate_visual_progress_summary = None
...
class TestEnhancedEndOfDayReporting:
    ...
    def sample_tomorrow_prep(self):
        ...
        return {
            ...
            "potential_blockers": [{"description": "API dependency", "impact": "HIGH"}],
    ...
    def test_should_generate_enhanced_eod_report_when_given_valid_day(
        self, mock_progress_generator, tmp_path
    ):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "src.infrastructure.scripts.generation.generate_task_report.Path"
                ) as mock_path_class:
                    with patch("builtins.open", create=True) as mock_open:
                        ...
                        mock_path_instance.__truediv__ = Mock(
                            return_value="test_report.md"
                        )
                        mock_file = Mock()
                        mock_open.return_value.__enter__.return_value = mock_file
                        with patch(
                            "src.infrastructure.scripts.generation.generate_task_report._calculate_sprint_velocity",
                            return_value={
                                "current_velocity": 2.5,
                                "trend": "increasing",
                            },
                            ...
                            with patch(
                                "src.infrastructure.scripts.generation.generate_task_report._analyze_tomorrow_preparation",
                                return_value={"total_planned": 3},
                            ):
                                with patch(
                                    "src.infrastructure.scripts.generation.generate_task_report._assess_sprint_health",
                                    return_value={"overall_score": 80},
                                ):
                                    with patch(
                                        "src.infrastructure.scripts.generation.generate_task_report._generate_visual_progress_summary",
                                        return_value="Visual Summary",
                                    ):
                                        with patch(
                                            "src.infrastructure.scripts.generation.generate_task_report._create_enhanced_eod_report",
                                            return_value="Enhanced Report",
                                        ):
    ...
    def test_should_calculate_sprint_velocity_with_trend_analysis(
        self, mock_progress_generator
    ):
    ...
    def test_should_analyze_tomorrow_preparation_with_priorities(
        self, mock_progress_generator
    ):
    ...
    def test_should_assess_sprint_health_with_comprehensive_indicators(
        self, mock_progress_generator
    ):
    ...
    def test_should_generate_visual_progress_summary(
        self, mock_progress_generator, sample_velocity_data
    ):
        """Test visual progress summary generation."""
        result = _generate_visual_progress_summary(
            mock_progress_generator, sample_velocity_data
        )
    ...
    def test_should_create_comprehensive_eod_report_with_all_sections(
        self, sample_velocity_data, sample_tomorrow_prep, sample_sprint_health
    ):
    ...
    def test_should_handle_missing_data_gracefully(self, mock_progress_generator):
        ...
        target_date = date(2025, 6, 1)
        velocity_result = _calculate_sprint_velocity(
            mock_progress_generator, target_date
        )
        assert isinstance(velocity_result, dict)
        tomorrow_result = _analyze_tomorrow_preparation(
            mock_progress_generator, target_date
        )
    ...
    def test_should_prioritize_high_impact_tasks_for_tomorrow(
        self, mock_progress_generator
    ):
