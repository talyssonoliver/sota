#!/usr/bin/env python3
"""
test_register_output.py - Optimized Test Structure

Migrated from: tests/workflows\test_register_output.py
New location: tests/unit\core\test_register_output.py
...
"""
    ...
    def test_code_extraction(self):
        ...
        # Check for TypeScript files (note: paths are flattened by the
        # registry)
    ...
    def test_get_task_status(self):
        ...
        self.assertEqual(status["agent_outputs"]
    ...
    def test_prepare_qa_input(self):
        ...
        # customerService.ts and orderService.ts
        self.assertTrue(len(typescript_files) >= 2)
...
class TestRegistrationIntegration(unittest.TestCase):
    ...
    def test_integration_with_existing_task_structure(self):
        ...
        prompt_file.write_text(
            "# Backend Agent Prompt for BE-07\n\nImplement service layer...")
...
def run_step_4_4_tests():
    ...
    success_rate = ((result.testsRun -
                     ...
                     len(result.errors)) /
                    result.testsRun *
                    100) if result.testsRun > 0 else 0
