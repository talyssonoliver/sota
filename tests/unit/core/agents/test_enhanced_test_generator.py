...
try:
    from src.core.agents.qa import EnhancedQAAgent, QAEngineer
...
class TestEnhancedQAAgent:
    ...
    def test_quality_gate_validation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            metrics = {"coverage": 85, "complexity": 2, "quality_score": 8.5}
...
"""
        ...
        validation_result = validation_engine.generate_comprehensive_tests(
            "PAY-01", source_code
        )
