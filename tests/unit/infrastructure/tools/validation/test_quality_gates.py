...
"""
    ...
    def test_calculate_cyclomatic_complexity(self):
        ...
        avg_complexity, max_complexity = (
            self.calculator.calculate_cyclomatic_complexity()
        )
...
"""
    ...
    def test_count_lines_of_code(self):
        ...
        assert (
            loc_metrics["total"]
            == loc_metrics["code"] + loc_metrics["blank"] + loc_metrics["comments"]
        )
    ...
    def test_count_critical_issues(self, mock_run):
        ...
        bandit_data = {
            "results": [
                ...
                {"issue_confidence": "MEDIUM", "issue_severity": "MEDIUM"},
            ]
        }
    ...
    def test_calculate_maintainability_index(self):
        ...
        index = self.calculator.calculate_maintainability_index(
            avg_complexity=5.0, lines_of_code=100, duplication=2.0
        )
...
"""
    ...
    def test_realistic_quality_evaluation(self):
        ...
        mock_report = {
            ...
            "technical_debt": {"estimated_hours": 4.2, "severity": "LOW"},
        }

        with patch.object(
            self.engine, "evaluate_quality_gates", return_value=mock_report
        ):
            report = self.engine.evaluate_quality_gates()
    ...
    def test_quality_gates_with_issues(self):
        ...
        mock_report = {
            ...
            "technical_debt": {"estimated_hours": 24.5, "severity": "HIGH"},
        }
