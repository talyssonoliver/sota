        ...
        try:
            ...
            with patch.object(cli, "model", Mock()) as mock_model:
                ...
                mock_response.content = (
                    "This is a simple Python file that prints Hello, World!"
                )
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(cli, "model", Mock()) as mock_model:
                ...
                result = cli.generate_code(
                    "Create a hello world function", str(output_file)
                )
...
class TestAsyncOperations:
    ...
    def test_chat_interactive_basic(self, mock_print, mock_input, mock_create_agent):
        ...
        # Mock the agent
        mock_agent = Mock()
        mock_response = {"messages": [Mock(content="Hello! How can I help you?")]}
