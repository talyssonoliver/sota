...
class TestHITLCLIManager(unittest.TestCase):
    ...
    def test_list_pending_checkpoints_all(self):
        ...
        mock_checkpoints = [{'checkpoint_id': 'hitl_BE-07_abc123', 'task_id': 'BE-07', 'checkpoint_type': 'output_evaluation', 'risk_level': 'high', 'reviewers': ['Backend Engineer', 'Technical Lead']}, {'checkpoint_id': 'hitl_FE-05_def456', 'task_id': 'FE-05', 'checkpoint_type': 'qa_validation', 'risk_level': 'medium', 'reviewers': ['QA Engineer']}]
    ...
    def test_list_pending_checkpoints_filtered_by_task(self):
        ...
        mock_checkpoints = [{'checkpoint_id': 'hitl_BE-07_abc123', 'task_id': 'BE-07', 'checkpoint_type': 'output_evaluation', 'risk_level': 'high', 'reviewers': ['Backend Engineer']}]
        self.mock_hitl_engine.get_pending_checkpoints.return_value = mock_checkpoints
    ...
    def test_approve_checkpoint_success(self):
        ...
        result = self.cli_manager.approve_checkpoint('hitl_BE-07_abc123', 'alice', 'Looks good to me')
        self.assertTrue(result)
        self.mock_hitl_engine.process_decision.assert_called_once()
        call_args = self.mock_hitl_engine.process_decision.call_args
        self.assertEqual(call_args[0][0], 'hitl_BE-07_abc123')
    ...
    def test_reject_checkpoint_success(self):
        ...
        self.mock_hitl_engine.process_decision.return_value = True
        result = self.cli_manager.reject_checkpoint('hitl_BE-07_abc123', 'bob', 'Security concerns', 'Missing input validation')
        self.assertTrue(result)
        self.mock_hitl_engine.process_decision.assert_called_once()
        call_args = self.mock_hitl_engine.process_decision.call_args
        decision = call_args[0][1]
    ...
    def test_escalate_checkpoint_success(self):
        ...
        result = self.cli_manager.escalate_checkpoint('hitl_BE-07_abc123', 'charlie', 'Needs management review', 2)
        self.assertTrue(result)
    ...
    def test_show_audit_trail_by_checkpoint(self):
        ...
        mock_audit_entries = [{'timestamp': '2025-06-08T10:00:00', 'action': 'created', 'user': 'system', 'checkpoint_id': 'hitl_BE-07_abc123', 'details': 'Checkpoint created for output evaluation'}, {'timestamp': '2025-06-08T10:30:00', 'action': 'approved', 'user': 'alice', 'checkpoint_id': 'hitl_BE-07_abc123', 'details': 'Approved after code review'}]
...
class TestHITLCLICommands(unittest.TestCase):
    ...
    def test_cmd_list_checkpoints_with_data(self, mock_print, mock_manager_class):
        ...
        mock_checkpoints = [{'checkpoint_id': 'hitl_BE-07_abc123', 'task_id': 'BE-07', 'checkpoint_type': 'output_evaluation', 'risk_level': 'high', 'reviewers': ['Backend Engineer'], 'deadline': '2025-06-08T18:00:00'}]
        mock_manager = Mock()
    ...
    def test_cmd_approve_checkpoint_with_confirmation(self, mock_input, mock_print, mock_manager_class):
        ...
        mock_details = {'checkpoint_id': 'hitl_BE-07_abc123', 'task_id': 'BE-07', 'checkpoint_type': 'output_evaluation', 'risk_level': 'high'}
        mock_manager = Mock()
        mock_manager.show_checkpoint_details.return_value = mock_details
        ...
        mock_manager.approve_checkpoint.assert_called_once_with('hitl_BE-07_abc123', 'alice', 'Looks good')
