...
class TestHITLCLIManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_metadata_manager = Mock(
            spec=["get_task", "save_task", "get_task_metadata"]
        )
        self.mock_dashboard_manager = Mock(
            spec=["update_dashboard", "get_dashboard_data"]
        )
    ...
    def test_list_pending_checkpoints_all(self):
        ...
        mock_checkpoints = [
            ...
            {
                "checkpoint_id": "hitl_FE-05_def45678",
                "task_id": "FE-05",
    ...
    def test_show_checkpoint_details(self):
        ...
        self.mock_hitl_engine.get_checkpoint.assert_called_once_with(
            "hitl_BE-07_abc1234545"
        )
    ...
    def test_approve_checkpoint_success(self):
        ...
        result = self.cli_manager.approve_checkpoint(
            "hitl_BE-07_abc12345", "alice", "Looks good to me"
        )
    ...
    def test_escalate_checkpoint_success(self):
        ...
        result = self.cli_manager.escalate_checkpoint(
            "hitl_BE-07_abc12345", "charlie", "Needs management review", 2
        )
        self.assertTrue(result)
    ...
    def test_show_audit_trail_by_checkpoint(self):
        ...
        self.mock_hitl_engine.get_audit_trail.assert_called_once_with(
            checkpoint_id="hitl_BE-07_abc12345"
        )
    ...
    def test_show_metrics(self):
        ...
        mock_metrics = {
            ...
            "risk_distribution": {"low": 20, "medium": 15, "high": 10, "critical": 5},
        }
...
class TestHITLCLICommands(unittest.TestCase):
    ...
    def test_cmd_approve_checkpoint_with_confirmation(
        self, mock_input, mock_print, mock_manager_class
    ):
        ...
        mock_manager.approve_checkpoint.assert_called_once_with(
            "hitl_BE-07_abc12345", "alice", "Looks good"
        )
        mock_print.assert_any_call(
            "✅ Checkpoint hitl_BE-07_abc12345 approved by alice"
        )

    @patch("src.interfaces.cli.hitl_cli.HITLCLIManager")
    @patch("builtins.print")
    @patch("builtins.input")
    def test_cmd_approve_checkpoint_cancelled(
        self, mock_input, mock_print, mock_manager_class
    ):
