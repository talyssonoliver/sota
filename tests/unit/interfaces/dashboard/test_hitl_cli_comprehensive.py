...
class TestHITLCLIManager:
    ...
    def setup_method(self):
        ...
        with patch('cli.hitl_cli.HITLPolicyEngine'), \
             patch('cli.hitl_cli.HITLTaskMetadataManager'), \
             patch('cli.hitl_cli.HITLDashboardManager'):
            self.cli_manager = HITLCLIManager()
    
    def test_cli_manager_initialization(self):
        """Test CLI manager initialization."""
        with patch('cli.hitl_cli.HITLPolicyEngine') as mock_engine, \
             patch('cli.hitl_cli.HITLTaskMetadataManager') as mock_metadata, \
             patch('cli.hitl_cli.HITLDashboardManager') as mock_dashboard:
    ...
    def test_list_pending_checkpoints(self):
        ...
        mock_checkpoints = [
            ...
            Mock(
                checkpoint_id='hitl_FE-01_def456',
                task_id='FE-01',
                risk_level='medium',
                created_at=datetime.now(),
    ...
    def test_list_pending_checkpoints_by_task(self):
        ...
        mock_checkpoints = [
            Mock(checkpoint_id='hitl_BE-07_abc123', task_id='BE-07'),
            Mock(checkpoint_id='hitl_BE-07_def456', task_id='BE-07'),
            Mock(checkpoint_id='hitl_FE-01_ghi789', task_id='FE-01')
        ]
    ...
    def test_get_checkpoint_details(self):
        ...
        mock_checkpoint = Mock(
            ...
            deadline=datetime.now() + timedelta(hours=4),
            reviewers=['john.doe'],
            risk_factors=['database_changes', 'security_impact'],
            content={'code_changes': 'Added new API endpoint'},
            approvals=[],
            rejections=[],
            escalation_level=0
        )
    ...
    def test_show_audit_trail(self):
        ...
        with patch.object(self.cli_manager.hitl_engine, 'get_audit_trail', return_value=mock_audit_entries):
            # Test with checkpoint_id filter
    ...
    def test_get_reviewer_stats(self):
        ...
        mock_stats = {
            'john.doe': {
                'checkpoints_reviewed': 20,
                'checkpoints_approved': 18,
                'checkpoints_rejected': 2,
                'average_review_time_hours': 3.2
            },
            'jane.smith': {
                'checkpoints_reviewed': 15,
                'checkpoints_approved': 14,
                'checkpoints_rejected': 1,
                'average_review_time_hours': 5.1
            }
        }
    ...
    def test_export_checkpoint_data(self):
        ...
        with patch.object(self.cli_manager, 'show_checkpoint_details', return_value=mock_checkpoint_details), \
    ...
    def test_import_checkpoint_data(self):
        ...
        with patch('builtins.open', create=True) as mock_open, \
             ...
             patch.object(self.cli_manager.hitl_engine, 'import_checkpoint', return_value=True):
...
class TestHITLCLICommands:
    ...
    def test_approve_command_execution(self):
        ...
        with patch('cli.hitl_cli.HITLCLIManager') as mock_manager_class, \
             patch('cli.hitl_cli.validate_checkpoint_id', return_value='hitl_BE-07_abc123'), \
             patch('cli.hitl_cli.validate_reviewer_name', return_value='john.doe'):
    ...
    def test_export_command_execution(self):
        ...
        with patch('cli.hitl_cli.HITLCLIManager') as mock_manager_class, \
             patch('cli.hitl_cli.validate_file_path', return_value=Path('checkpoints.json')):
...
class TestHITLCLIValidation:
    ...
    def test_validate_checkpoint_id_invalid(self):
        ...
        from src.interfaces.cli.hitl_cli import validate_checkpoint_id
        from src.platform.utils.input_validation import ValidationError
...
class TestHITLCLIIntegration:
    ...
    def test_complete_review_workflow(self):
        ...
        with patch('cli.hitl_cli.HITLCLIManager') as mock_manager_class:
            ...
            mock_manager.get_checkpoint_details.return_value = {
                'checkpoint_id': 'hitl_BE-07_abc123',
            ...
            # Simulate workflow: list -> details -> approve
    ...
    def test_bulk_operations_workflow(self):
        ...
        with patch('cli.hitl_cli.HITLCLIManager') as mock_manager_class:
            ...
            # Setup multiple pending checkpoints
            mock_checkpoints = [
                {'checkpoint_id': f'hitl_BE-{i:02d}_abc{i}23', 'task_id': f'BE-{i:02d}'}
                for i in range(1, 6)
            ]
    ...
    def test_error_handling_workflow(self):
        ...
        with patch('cli.hitl_cli.HITLCLIManager') as mock_manager_class:
            ...
            mock_manager.get_checkpoint_details.return_value = None  # Not found
            mock_manager.approve_checkpoint.return_value = False    # Approval failed
            mock_manager_class.return_value = mock_manager
    ...
    def test_data_export_import_workflow(self):
        ...
        with patch('cli.hitl_cli.HITLCLIManager') as mock_manager_class, \
             patch('builtins.open', create=True) as mock_open, \
             patch('json.dump') as mock_json_dump, \
             patch('json.load', return_value=export_data):
