...
try:
    from src.interfaces.cli.hitl_cli import (  # type: ignore
        HITLCLIManager,
        setup_logging,
    )
...
class TestHITLCLIManager:
    ...
    def setup_method(self):
        ...
        with patch("src.interfaces.cli.hitl_cli.HITLPolicyEngine"), patch(
            "src.interfaces.cli.hitl_cli.HITLTaskMetadataManager"
    ...
    def test_cli_manager_initialization(self):
        ...
        with patch(
            "src.interfaces.cli.hitl_cli.HITLPolicyEngine"
        ) as mock_engine, patch(
            "src.interfaces.cli.hitl_cli.HITLTaskMetadataManager"
        ) as mock_metadata, patch(
            "src.interfaces.cli.hitl_cli.HITLDashboardManager"
        ) as mock_dashboard:
            manager = HITLCLIManager()
            # Add assertion for manager object
    ...
    def test_get_checkpoint_details(self):
        ...
        with patch.object(
            self.cli_manager.hitl_engine, "get_checkpoint", return_value=mock_checkpoint
        ):
    ...
    def test_show_checkpoint_details(self):
        ...
        mock_checkpoint = Mock(
            ...
            content={"code_changes": "Added new API"},
            mitigation_suggestions=["Review code", "Test thoroughly"],
    ...
    def test_get_checkpoint_details_not_found(self):
        ...
        with patch.object(
            self.cli_manager.hitl_engine, "get_checkpoint", return_value=None
        ):
    ...
    def test_approve_checkpoint(self):
        ...
        with patch.object(
            self.cli_manager.hitl_engine, "process_decision", return_value=True
        ) as mock_approve:
    ...
    def test_approve_checkpoint_failure(self):
        ...
        with patch.object(
            self.cli_manager.hitl_engine, "process_decision", return_value=False
        ):
            result = self.cli_manager.approve_checkpoint(
                checkpoint_id="hitl_BE-07_abc12345",
                reviewer="john.doe",
    ...
    def test_escalate_checkpoint(self):
        ...
        with patch.object(
            self.cli_manager.hitl_engine, "escalate_checkpoint", return_value=True
        ) as mock_escalate:
            ...
            assert result is True
            # Add mock verification for mock_escalate
    ...
    def test_get_checkpoint_history(self):
        ...
        mock_history = [
            {
                ...
                "action": "created",
                "user": "system",
                "details": {"checkpoint_type": "output_evaluation"},
            },
            {
                "timestamp": datetime.now().isoformat(),
                "action": "reviewed",
        ...
        with patch.object(
            self.cli_manager.hitl_engine, "get_audit_trail", return_value=mock_history
        ):
        ...
        mock_audit_entries = [
            Mock(
                to_dict=lambda: {
                    ...
                    "checkpoint_id": "hitl_BE-07_abc12345",
                    "task_id": "BE-07",
                    "details": {"type": "output_evaluation"},
                }
            ),
            {
                "timestamp": datetime.now().isoformat(),
    ...
    def test_get_hitl_metrics(self):
        ...
        mock_metrics = {
            ...
            "approved_checkpoints": 40,
            "rejected_checkpoints": 3,
            "escalated_checkpoints": 2,
            "average_review_time_hours": 4.5,
            "approval_rate": 0.89,
        }
        with patch.object(
            self.cli_manager.hitl_engine, "get_metrics", return_value=mock_metrics
        ):
    ...
    def test_show_metrics(self):
        ...
        mock_metrics = {
            ...
            "risk_distribution": {"low": 30, "medium": 45, "high": 20, "critical": 5},
        }
        with patch.object(
            self.cli_manager.hitl_engine, "get_metrics", return_value=mock_metrics
        ):
    ...
    def test_export_checkpoint_data(self):
        ...
        with patch.object(
            ...
            return_value=mock_checkpoint_details,
        ), patch("builtins.open", create=True) as mock_open, patch(
            "json.dump"
        ) as mock_json_dump:
            result = self.cli_manager.export_checkpoint_data(
                "hitl_BE-07_abc12345", "export.json"
            )
            assert result is True
    ...
    def test_export_checkpoint_data_not_found(self):
        ...
        with patch.object(
            self.cli_manager, "show_checkpoint_details", return_value=None
        ):
            result = self.cli_manager.export_checkpoint_data(
    ...
    def test_validate_checkpoint_integrity(self):
        ...
        with patch.object(
            ...
            result = self.cli_manager.validate_checkpoint_integrity(
                "hitl_BE-07_abc12345"
            )
        ...
        with patch.object(
            self.cli_manager.hitl_engine,
            "get_checkpoint",
            return_value=mock_invalid_checkpoint,
        ):
            result = self.cli_manager.validate_checkpoint_integrity(
                "hitl_BE-07_abc12345"
            )
...
class TestHITLCLICommands:
    ...
    def test_list_command_execution(self):
        ...
        mock_args = argparse.Namespace(
            command="list", reviewer=None, task_id=None, format="table", verbose=False
        )
        mock_checkpoints = [
            {
                "checkpoint_id": "hitl_BE-07_abc12345",
    ...
    def test_details_command_execution(self):
        ...
        with patch("src.interfaces.cli.hitl_cli.HITLCLIManager") as mock_manager_class:
            ...
            mock_manager.show_checkpoint_details.assert_called_once_with(
                "hitl_BE-07_abc12345"
            )
    ...
    def test_approve_command_execution(self):
        ...
        with patch(
            "src.interfaces.cli.hitl_cli.HITLCLIManager"
        ) as mock_manager_class, patch(
            "src.interfaces.cli.hitl_cli.validate_checkpoint_id",
            return_value="hitl_BE-07_abc12345",
        ), patch(
            "src.interfaces.cli.hitl_cli.validate_reviewer_name",
    ...
    def test_metrics_command_execution(self):
        ...
        mock_args = argparse.Namespace(
            command="metrics", days=30, format="table", verbose=False
        )
        mock_metrics = {
    ...
    def test_export_command_execution(self):
        ...
        with patch(
            ...
            "src.interfaces.cli.hitl_cli.validate_file_path",
            ...
            assert result == 0
            mock_manager.export_checkpoint_data.assert_called_once_with(
                "hitl_BE-07_abc12345", "checkpoints.json"
            )
...
class TestHITLCLIValidation:
    ...
    def test_validate_reviewer_name_invalid(self):
        ...
        invalid_names = [
            ...
            "123invalid",
            "user@domain",
            "very_long_name_that_exceeds_the_maximum_length_limit",
        ]
...
class TestHITLCLIIntegration:
    ...
    def test_complete_review_workflow(self):
        ...
        mock_manager.show_checkpoint_details.return_value = {
            "checkpoint_id": "hitl_BE-07_abc12345",
            "content": {"changes": "Added new API"},
            "risk_factors": ["database_changes"],
        }
        mock_manager.approve_checkpoint.return_value = True
        ...
        approved = cli_manager.approve_checkpoint(
            "hitl_BE-07_abc12345", "john.doe", "Reviewed and approved"
        )
        assert approved is True
        # Add mock verification call for approve_checkpoint
        cli_manager.approve_checkpoint.assert_called()
    ...
    def test_bulk_operations_workflow(self):
        ...
        with patch("src.interfaces.cli.hitl_cli.HITLPolicyEngine") as mock_engine_class:
            ...
            mock_checkpoints = [
                {
                    "checkpoint_id": f"hitl_BE-{i:02d}_abc12345{i}",
                    "task_id": f"BE-{i:02d}",
                }
                for i in range(1, 6)
            ]
            mock_engine.get_pending_checkpoints.return_value = mock_checkpoints
            mock_engine.process_decision.return_value = (
                True  # This is what approve_checkpoint actually calls
            )
            mock_engine_class.return_value = mock_engine

            # Mock other dependencies
            with patch("src.interfaces.cli.hitl_cli.HITLTaskMetadataManager"), patch(
                "src.interfaces.cli.hitl_cli.HITLDashboardManager"
            ):
                ...
                for checkpoint in pending:
                    result = cli_manager.approve_checkpoint(
                        checkpoint["checkpoint_id"], "bulk_reviewer", "Bulk approval"
                    )
                    approval_results.append(result)
                assert all(approval_results)
                # Add mock verification call for bulk operations
                assert mock_engine.process_decision.call_count == 5
                mock_engine.process_decision.assert_called()
    ...
    def test_error_handling_workflow(self):
        ...
        with patch(
            ...
            mock_engine.process_decision.return_value = (
                False  # Simulate approval failure
            )
            mock_engine_class.return_value = mock_engine
            ...
            approved = cli_manager.approve_checkpoint(
                "hitl_BE-07_abc12345", "john.doe", "Approval attempt"
            )
    ...
    def test_data_export_import_workflow(self):
        ...
        with patch(
            ...
            "json.load", return_value=export_data
        ):
            # Setup file mock for operations
            mock_file.return_value.__enter__.return_value.write = MagicMock()
            # Setup JSON mock for data operations
            ...
            cli_manager = (
                mock_manager_class()
            )  # Use the mocked class instead of calling real constructor
            export_result = cli_manager.export_checkpoint_data(
                str(self.test_file), format="json"
            )
