...
def apply_all_patches():
    ...
    try:
        from patches.chromadb_telemetry_patch import apply_patch as apply_chromadb_patch
    ...
    logger.info(f"Applied {success_count} patches successfully, {failure_count} failed")
