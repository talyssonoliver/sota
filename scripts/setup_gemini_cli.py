...
def show_usage_examples():
    ...
    print("python src/interfaces/cli/gemini_cli.py analyze ./src --output analysis.json")
    print()
    print("# Generate code")
    print("python src/interfaces/cli/gemini_cli.py generate 'Create a new agent' --output agent.py")
    print()
