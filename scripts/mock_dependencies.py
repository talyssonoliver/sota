...
def patch_imports():
    ...
    def patch_registry():
        try:
            ...
            if not hasattr(registry_module, 'get_agent'):
                ...
                print(
                    "Successfully patched orchestration.registry with get_agent function")
    ...
    try:
        ...
        mock_langchain_community_embeddings = ModuleType(
        ...
        mock_langchain_community_vectorstores = ModuleType(
        ...
        mock_langchain_community_loaders = ModuleType(
