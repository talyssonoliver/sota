...
from orchestration.summarise_task import TaskSummarizer, TaskArtifact, AgentOutput, QAResults
        ...
        'agent_outputs': [
            {
                ...
                'status': 'completed',
                'files_generated': ['src/api/routes.py', 'src/models/user.py', 'tests/test_api.py'],
            ...
            },
            {
                ...
                'status': 'completed',
                'files_generated': ['src/components/UserProfile.tsx', 'src/pages/Dashboard.tsx'],
            ...
            },
            {
                ...
                'status': 'completed',
                'files_generated': ['docs/api.md', 'docs/frontend-guide.md', 'README.md'],
                'files_modified': [],
                'metadata': {
                    'pages_generated': 3,
        ...
        'tasks': [
            {
                ...
                'priority': 'high',
                'estimated_hours': 16,
                'assigned_agents': ['backend_agent', 'frontend_agent', 'documentation_agent']
            }
        ]
    }
