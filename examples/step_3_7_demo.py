...
def test_memory_engine_integration():
    ...
    try:
        ...
        if log_data:
            ...
            print(f"   Within budget: {log_data.get('within_budget', 'unknown')}")
            print(f"   Step 3.5 integration: {log_data.get('step_3_5_integration', False)}")
            return True
        else:
...
def test_report_generation():
    ...
    if success:
        ...
        print(f"   Unique documents: {len(summary.get('document_usage_frequency', {}))}")
