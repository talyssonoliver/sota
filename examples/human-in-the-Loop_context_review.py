    ...
    try:
        ...
        if result.returncode == 0:
            ...
            if reports_dir.exists():
                json_files = list(reports_dir.glob(
                    "context_review_BE-07_*.json"))
                if json_files:
        ...
        if result.returncode == 0:
            ...
            if context_log_path.exists():
                ...
                if (log_data.get('agent_role') in ['human_reviewer', 'reviewer'] or
                    ...
                    print(
                        f"[DEBUG] Additional metadata: {additional_metadata}")
                    return False
            else:
...
def main():
    ...
    if success:
        ...
        print(
            "🔍 CLI tool available: python orchestration/review_context.py [TASK-ID]")
