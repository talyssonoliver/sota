...
from src.core.workflows.hitl_engine import HITLPolicyEngine, RiskLevel
...
class AdvancedReviewPortal:
    ...
    def _interactive_review(self, task_id: str, reviewer: str, task_data: Dict[str, Any],
        ...
        while True:
            print("\nOptions:")
            print("1. Approve task")
            print("2. Reject task")
            print("3. Request changes")
            print("4. Escalate to senior reviewer")
            print("5. View detailed output")
            print("6. Export review data")
            print("7. Exit without decision")
    ...
    def _interactive_checkpoint_review(self, checkpoint: Any, reviewer: str) -> Dict[str, Any]:
        ...
        while True:
            print("\nOptions:")
            print("1. Approve checkpoint")
            print("2. Reject checkpoint")
            print("3. Escalate checkpoint")
            print("4. View related task")
            print("5. Export checkpoint data")
            print("6. Exit")
